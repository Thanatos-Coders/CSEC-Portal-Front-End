export function OptionalInformation() {
  ...
  <h1 className="text-2xl font-bold text-gray-800 mb-6">Additional Information</h1>
  ...
  <div className="flex flex-wrap gap-6">
    ...
    <div className="flex-1 min-w-[250px]">
      ...
      <div className="flex flex-col gap-1" style={{marginBottom: "20px"}}>
        <span className="text-sm font-medium text-gray-500">LinkedIn Account</span>
        <a href="https://linkedin.com/henokassefa/profile" className="text-blue-600 hover:underline font-medium">linkedin.com/henokassefa/profile</a>
        <div className="w-full border-b border-gray-300"></div>
      </div>
      
      <div className="flex flex-col gap-1" style={{marginBottom: "20px"}}>
        <span className="text-sm font-medium text-gray-500">Codeforces Handle</span>
        <a href="https://codeforces/hena_bakos" className="text-blue-600 hover:underline font-medium">codeforces/hena_bakos</a>
        <div className="w-full border-b border-gray-300"></div>
      </div>
      
      <div className="flex flex-col gap-1" style={{marginBottom: "20px"}}>
        <span className="text-sm font-medium text-gray-500">Leetcode Handle</span>
        <a href="https://leetcode/Hena_bakos" className="text-blue-600 hover:underline font-medium">leetcode/Hena_bakos</a>
        <div className="w-full border-b border-gray-300"></div>
      </div>
    </div>
    ...
    <div className="flex-1 min-w-[250px]">
      <div className="flex flex-col gap-1" style={{marginBottom: "20px"}}>
        <span className="text-sm font-medium text-gray-500">Instagram Handle</span>
      ...
      <div className="flex flex-col gap-1" style={{marginBottom: "20px"}}>
        ...
        <a href="https://github.com/Henabakos/Admin-edstelar" className="text-blue-600 hover:underline font-medium">github.com/Henabakos/Admin-edstelar</a>
        <div className="w-full border-b border-gray-300"></div>
      </div>
